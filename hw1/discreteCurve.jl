...
scene1 = lines!(scene1, x, y,
                linewidth=3, color=RGBAf0(0.8, 0.05, 0.1))
scene1 = arrows!(scene1, x[2:end-1], y[2:end-1], u, v,
                 arrowsize=0.05)
...
scene2 = lines!(scene2, x, y, linewidth=4, color=c, colorrange=(0,4))
scene2 = lines!(scene2,
...
scene3 = lines!(scene3, curve[:,1], curve[:,2],
                linewidth=3, color=RGBAf0(0.8, 0.05, 0.1))
lineplt = scene3[end]
